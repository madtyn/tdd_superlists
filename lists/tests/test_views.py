...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def test_passes_POST_data_to_NewListForm(self, mockNewListForm):
        ...
        # This mock implies we need to initialize our form and we should have a new different test for that
        mockNewListForm.assert_called_once_with(data=self.request.POST)

    def test_saves_form_with_owner_if_form_valid(self, mockNewListForm):
        mock_form = mockNewListForm.return_value

        # This mock implies we should have an is_valid() function returning True/False
        mock_form.is_valid.return_value = True
        new_list(self.request)
        # This mock implies the form should have a .save method which will accept a request.user and deal with it
    ...
    def test_redirects_to_form_returned_object_if_form_valid(self, mock_redirect, mockNewListForm):
        ...
        # This mock implies the save method should return a new list object, for our view to redirect the user to 
